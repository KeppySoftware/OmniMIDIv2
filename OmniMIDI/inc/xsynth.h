...
#define MIDI_EVENT_NOTEON 0

#define MIDI_EVENT_NOTEOFF 1

#define MIDI_EVENT_ALLNOTESOFF 2

#define MIDI_EVENT_ALLNOTESKILLED 3

#define MIDI_EVENT_RESETCONTROL 4

#define MIDI_EVENT_CONTROL 5

#define MIDI_EVENT_PROGRAMCHANGE 6

#define MIDI_EVENT_PITCH 7

#define MIDI_EVENT_FINETUNE 8

#define MIDI_EVENT_COARSETUNE 9
